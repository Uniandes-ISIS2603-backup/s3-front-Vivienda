...
export class SitioInteresService
{
    ...
    getSitiosInteres(): SitioInteres[]
    {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            let descripccion = "Ipsum bibendum lectus egestas cursus lacinia mi ullamcorper natoque dictumst. Blandit at varius penatibus diam senectus.Molestie vestibulum proin mauris cras cras tempus et facilisi congue suspendisse a nascetur."      
